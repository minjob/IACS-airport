<template>
  <el-row :gutter="15">
      <el-col :span="24">
        ...
        <el-col :span="24" style="background: #0A3C7C;overflow: hidden;position: relative;" v-if="TabControl.TabControlCurrent === '大系统'">
          <div class="MainContain BorderRadius4 SysMonbg" @mousedown="move" data-move>

         </div>
        </el-col>
        <el-col :span="24" style="background: #0A3C7C;overflow: hidden;position: relative;" v-if="TabControl.TabControlCurrent === '小系统'">
        ...
        <!--<el-row :gutter="15" style="overflow: hidden;" v-if="TabControl.TabControlCurrent === '冷水系统'">-->
          ...
          <!--</el-col>-->
        <!--</el-row>-->
        <el-col :span="24" style="background: #0A3C7C;overflow: hidden;position: relative;" v-if="TabControl.TabControlCurrent === '冷水系统'">
          <div class="MainContain BorderRadius4 coolingSysMonbg" @mousedown="move" data-move >
        ...
        <el-col :span="24" style="background: #0A3C7C;overflow: hidden;position: relative;" v-if="TabControl.TabControlCurrent === '设备房温度'">
